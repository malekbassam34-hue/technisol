    ...
    <div className="mt-12 grid gap-6 sm:grid-cols-2">
      {features.map((feature, index) => (
        <motion.div
          ...
          className="group rounded-[28px] border border-cyan-300/20 bg-[#0d3156]/55 p-7 backdrop-blur-[18px] shadow-[0_20px_60px_rgba(0,180,255,.15)] transition-all duration-300"
        >
